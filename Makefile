...
all : kmax_truss_omp kmax_truss_cuda kmax_truss_serial kron_gen
...
.PHONY : clean
clean :
	rm kmax_truss_omp kmax_truss_serial kmax_truss_cuda kron_gen *.o
